...
const Footer = (props: Props) => {
  return (
    <div className="w-full mt-auto flex flex-col md:flex-row z-50 h-full py-8 justify-center items-center gap-4 font-medium px-4 md:px-12 border-t-[1px] border-slate-900 bg-[#040112]">
